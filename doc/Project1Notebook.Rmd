...
legend("topright", 
       ...
       cex = 0.5)
invisible(dev.copy(png,'../figs/allcountires.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/immigrantparty.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/southeastasianparty.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/southamericanparty.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/southamericanreligion.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/eligiblevsactual.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/youngerasians.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/immigrantsWhoDontVote.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/partyOfDreamers.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/HistogramOfDreamers.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/EducationOfDreamers.png'))
invisible(dev.off())
```
...
legend("topright", 
       ...
       fill = rainbow(length(x)), ncol = 3,
       cex = 0.9)
invisible(dev.copy(png,'../figs/races.png'))
invisible(dev.off())
```
...
invisible(dev.copy(png,'../figs/EthnicityOfDreamers.png'))
invisible(dev.off())
```
